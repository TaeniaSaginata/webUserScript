...
const moonSVG = (width, color) => (`<?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
...
function setModeInfo(tag) {
    ...
    tag.innerHTML = !isLightMode() ? moonSVG(2, "#ffffff") : sunSVG(2, "#000000");
}
